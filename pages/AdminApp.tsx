...
import { 
  ...
  Type, Maximize2, Tag, ArrowRight, MoveLeft, MoveRight, Info, Globe, Users, ShoppingBag, Hand
} from 'lucide-react';
               ...
               <div className="col-span-2 bg-gray-50 rounded-2xl p-5 border border-gray-100">
                  <div className="flex justify-between items-center mb-4">
                     ...
                     <div className="flex items-center bg-gray-200 rounded-lg p-1 gap-1">
                        ...
                        <button type="button" onClick={() => setUseVariants(true)} className={`px-3 py-1.5 rounded-md text-xs font-bold transition-all ${useVariants ? 'bg-white shadow text-gray-900' : 'text-gray-500'}`}>Variantlar</button>                     </div>
                  </div>
    ...
    <div className="flex h-screen bg-[#F8F9FC] font-sans text-gray-900 overflow-hidden">
      <aside className="w-72 bg-white flex flex-col border-r border-gray-100 z-20 hidden lg:flex shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
         ...
         <div className="mt-auto p-6 border-t border-gray-50">
            ...
            <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 text-red-600 bg-white border border-red-100 py-3 rounded-xl font-bold text-sm hover:bg-red-50 transition-colors">
